...
from common_v08 import require_nonempty_text, sha256_digest
from endpoint_v08 import EpisodeRCS, PRIMARY_ENDPOINTS


TAIL_METHOD = "BONFERRONI_CP_RISK_DIFFERENCE_V1"
SOFTWARE_PROFILE = ("analysis-v0.8", "scipy-t-beta")
...
def default_plan(blocks: Sequence[str], scoring_config_digest: str, *, plan_id: str = "ESTHER-PLAN-v0.8") -> AnalysisPlan:
