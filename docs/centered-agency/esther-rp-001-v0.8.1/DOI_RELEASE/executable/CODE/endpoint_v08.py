...
from common_v08 import ObligationStatus, ResponseStatus, require_nonempty_text, sha256_digest
...
class ScoringConfig:
    config_id: str = "ESTHER-SCORING-v0.8"
    par_label_weight: float = 0.6
    par_lineage_weight: float = 0.4
    failure_post_loss: float = 1.0
    parser_version: str = "parser-v0.8"
    codebook_version: str = "codebook-v0.8"
