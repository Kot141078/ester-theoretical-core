...
from common_v07 import require_nonempty_text, require_nonnegative_int, sha256_digest
...
def verify_authority_binding(request: ControlRequest, descriptor: OperationDescriptor, decision: AuthorityDecision | None) -> str | None:
